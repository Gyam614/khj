...
<link rel="icon" href="http://localhost:8080/jsp2/static/images/uja.ico">
...
<script src="<%=path%>static/js/signUp.js"></script>
	...
	<div id="wrap">
		...
		<form method="post" action="signUpSave.jsp">
			...
			<div id="formData">
				...
				<div class="inputField">
					<b>생일 년월</b>
					<select id="birthYear" name = "birthY" ></select>	
					<label for="birthYear">년</label>	
					<select id="birthMonth" name = "birthM" ></select>
